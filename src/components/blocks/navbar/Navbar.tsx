  ...
  return (
    <>
      ...
      <header className="wrapper">
        <nav className="navbar navbar-expand-lg center-nav transparent navbar-dark bg-secondary shadow sticky top-0">
          <div className="nav_content_container container flex-lg-row flex-nowrap align-items-center py-3">
            <div className="navbar-brand w-100 py-0">
              <a href="{{ url('') }}/mp/{{ $locale }}" aria-label="AgendaPro">
                <img
                  className="logo"
                  src="/img/logo-ap-new-fondo-oscuro.svg"
                  alt=""
                  width={160}
                  height="29.16"
                />
            ...
            <div className="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
              <div className="offcanvas-header d-lg-none">
                <img
                  ...
                  data-src="/img/logo-agendapro.svg"
                  alt=""
                  width={160}
                  height="29.16"
                />
